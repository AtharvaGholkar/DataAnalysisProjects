...
1. [Task 1 - Framing the Business Scenario](#task-1---framing-the-business-scenario)
2. [Task 2 - Choosing the Right Visuals](#task-2---choosing-the-right-visuals)
3. [Task 3 - Creating Effective Visuals](#task-3---creating-effective-visuals)
4. [Task 4 - Communicating Insights and Analysis](#task-4---communicating-insights-and-analysis)
...
A meeting with the CEO and CMO has been scheduled for next month and you need to draft the relevant analytics and insights that would help evaluate the current business performance and suggest metrics that would enable them to decide on expansion.
